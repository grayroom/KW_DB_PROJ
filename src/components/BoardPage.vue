<template>
  <div class='max-w-[64rem] min-w-[18rem] mx-auto'>
    ...
    <div id="toolbar" class="pt-5 flex justify-between">
      ...
      <div id="search-tap" class="flex flex-row justify-between gap-2">
        ...
        <div class="relative w-full">
          ...
          <input type="text" id="simple-search" ref="searchTitle" v-model="searchKeyword"
        ...
        <button v-on:click="getArticleList"
      ...
      axios.post('/api/article/list',
          {
            ...
            stock_code: this.$route.params.stock, // 0: 전체, other : stockIdx
